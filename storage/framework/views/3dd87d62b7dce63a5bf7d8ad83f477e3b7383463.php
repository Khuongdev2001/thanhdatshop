...
<?php $__env->startSection("title",isset($brand) ? "Cập Nhật Thương Hiệu" :"Thêm Thương Hiệu"); ?>
...
<?php $__env->startSection("js"); ?>
    ...
    <script>
        ...
        $('#table.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.product.brand.datatable")); ?>',
            columns: [
        ...
        UploadFile({
            ...
            file: "<?php echo e(isset($brand->brand_image) ? asset($brand->brand_image) : ""); ?>"
        });
    </script>
<?php $__env->stopSection(); ?>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                     <div class="breadcomb-wp">
                        ...
                        <div class="breadcomb-ctn">
                           <h2><?php echo e(isset($brand) ? "Cập Nhật Thương Hiệu" : "Thêm Thương Hiệu"); ?></h2>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="review-tab-pro-inner">
                  <div id="myTabContent" class="tab-content custom-product-edit">
                     <form id="form-add-brand" action="<?php echo e(isset($brand) 
                     ? route("admin.product.brand.update",$brand->brand_id) 
                     : route("admin.product.brand.add")); ?>" enctype="multipart/form-data" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        <input type="text" class="form-control" id="brand_name" name="brand_name" 
                                           value="<?php echo e(old("brand_name") ?? $brand->brand_name ?? null); ?>" placeholder="Tên Thương Hiệu">
                                ...
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        <input type="text" class="form-control" id="brand_link" name="brand_link" 
                                           value="<?php echo e($brand->brand_link ?? null); ?>" placeholder="Link Đích">
                                     </div>
                                </div>
                                <!-- sort -->
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        ...
                                        value="<?php echo e($brand->sort ?? null); ?>" placeholder="Vị Trí">
                                        <span class="help-block small invalid-feedback"></span>
                                     </div>
                                </div>
                                <!-- thumbnail-->
                                <div class="form-group">
                                    ...
                                    <div class="mg-b-pro-edt upload-widget-wrapper">
                                        <div class="upload-file">
                                            <a href="" class="box-thumbnail btn-upload"><img src="<?php echo e(asset("source/admin/css/upload/img/icon.png")); ?>" class="thumbnail"></a>
                                            <div class="box-btn">                    
                                ...
                                <div class="text-center custom-pro-edt-ds">
                                    ...
                                    <a href="<?php echo e(route("admin.product.brand.add")); ?>" class="btn btn-ctl-bt waves-effect waves-light">Quay Lại Thêm T.Hiệu</a>
                                 </div>
                            </div>
                        </div>
                     </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\thanh_dat\thanhdat_cosmetics\resources\views/admin/product/brand/add.blade.php ENDPATH**/ ?>