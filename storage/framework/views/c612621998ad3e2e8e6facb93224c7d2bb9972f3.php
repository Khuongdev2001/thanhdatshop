            ...
            <div class="box-form">
                ...
                <h3 class="title">Đăng Ký<h3>
                    ...
                    <div class="login-more">
                        ...
                        <div class="socials">
                            <a href="<?php echo e(route("user.login.social",1)); ?>" class="social-item">
                                <img src="<?php echo e(asset("source/img/web/facebook.png")); ?>" alt="facebook">
                            </a>
                            <a href="<?php echo e(route("user.login.social",2)); ?>" class="social-item">
                                <img src="<?php echo e(asset("source/img/web/google.png")); ?>" alt="google">
                            </a>
                        </div>
                    </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\thanh_dat\thanhdat_cosmetics\resources\views/user/master/modal.blade.php ENDPATH**/ ?>