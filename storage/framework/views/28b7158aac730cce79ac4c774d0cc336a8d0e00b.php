                ...
                <div class="account-info bg-light">
                    ...
                    <form action="" id="form-update-account">
                        <div class="form-group my-20 form-group-outline">
                            ...
                            <input type="text" id="fullname" class="form-control" value="<?php echo e($userLogin->fullname); ?>" data-field="fullname">
                        ...
                        <div class="form-group-2x">
                            <div class="form-group my-20 form-group-outline">
                                ...
                                <input type="text" id="phone" class="form-control" value="<?php echo e($userLogin->phone); ?>" data-field="phone">
                                <span class="invalid-feedback"></span>
                                <div class="line"></div>
                            </div>
                            <div class="form-group my-20 form-group-outline">
                                <label for="email">Email</label>
                                <input type="text" id="email" class="form-control" value="<?php echo e($userLogin->email); ?>" data-field="email">
                                <span class="invalid-feedback"></span>
                                <div class="line"></div>
                            </div>
                        </div>
...
<?php echo $__env->make("user.master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\thanh_dat\thanhdat_cosmetics\resources\views/user/user/account.blade.php ENDPATH**/ ?>