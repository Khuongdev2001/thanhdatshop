...
<?php $__env->startSection("title",empty($menu) ? "Thêm Menu" : "Cập Nhật Menu"); ?>
...
<?php $__env->startSection("js"); ?>
    ...
    <script>
        ...
        $('#table.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.template.menu.datatable")); ?>',
            columns: [
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                     <div class="breadcomb-wp">
                        ...
                        <div class="breadcomb-ctn">
                           <h2><?php echo e(isset($menu) ? "Cập Nhật Menu" : "Thêm Menu"); ?></h2>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="review-tab-pro-inner">
                  <div id="myTabContent" class="tab-content custom-product-edit">
                     <form id="form-add-menu" action="<?php echo e(isset($menu) 
                     ? route("admin.template.menu.update",$menu->menu_id) 
                     : route("admin.template.menu.add")); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        <input type="text" class="form-control" id="menu_title" name="menu_title" 
                                           value="<?php echo e(old("menu_title") ?? $menu->menu_title ?? null); ?>" placeholder="Tên Menu">
                                ...
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        <input type="text" class="form-control" id="menu_link" name="menu_link" 
                                           value="<?php echo e($menu->menu_link ?? null); ?>" placeholder="link">
                                     </div>
                                </div>
                                <!-- menu parent -->
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        <select class="form-control pro-edt-select form-control-primary" id="parent_id" name="parent_id">
                                            ...
                                            <?php echo e(showCat($menus,0,!empty($menu) ? $menu->parent_id : null)); ?>
                                ...
                                <div class="form-group">
                                    <div class="mg-b-pro-edt">
                                        ...
                                        value="<?php echo e($menu->sort ?? null); ?>" placeholder="Vị Trí">
                                        <span class="help-block small invalid-feedback"></span>
                                     </div>
                                </div>
                                <div class="text-center custom-pro-edt-ds">
                                    <button class="btn btn-ctl-bt waves-effect waves-light m-r-10">Lưu </button>
                                    <a href="<?php echo e(route("admin.template.menu.add")); ?>" class="btn btn-ctl-bt waves-effect waves-light">Quay Lại Thêm Menu</a>
                                 </div>
                            </div>
                        </div>
                     </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.master.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\thanh_dat\thanhdat_cosmetics\resources\views/admin/template/menu/add.blade.php ENDPATH**/ ?>