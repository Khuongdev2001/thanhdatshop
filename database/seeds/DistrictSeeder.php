...
class DistrictSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $districts = json_decode($districtStr, true);
        foreach ($districts as &$district) {
            $district["province_id"]=(int) $district["idProvince"];
            $district["district_id"] = (int) $district["idDistrict"];
            $district["district_name"] =  $district["name"];
            unset($district["idProvince"],$district["idDistrict"],$district["name"]);
        }
