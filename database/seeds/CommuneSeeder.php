...
"name": "Xã Đất Mũi"
        ...
        $communes = json_decode($communesStr, true);
        // dd($communes);
        foreach ($communes as &$commune) {
            $commune["commune_id"] = (int) $commune["idCommune"];
            $commune["district_id"]=(int) $commune["idDistrict"];
            $commune["commune_name"]=$commune["name"];
            unset($commune["idCommune"],$commune["idDistrict"],$commune["name"]);
        }
