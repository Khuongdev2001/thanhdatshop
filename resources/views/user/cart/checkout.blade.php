        ...
        <div class="checkout">
            <div class="box-top">
                ...
                <a href="" class="box-hotline d-block">
                    <img src="{{asset("source/img/web/hotline.png")}}" class="thumbnail w-100" alt="">
                </a>
            </div>
            ...
            <div class="box-bottom">
                <div class="info-buyer">
                    <p class="title 
                        {{["text-pink-weight","text-success","text-primary",-1=>"text-dark"][$cart->cart_status]}}
                    fw-600 fs-18">
                        {{
                            [
                    ...
                    <div class="box-cart-code pt-10">
                        ...
                        <span class="cart-code btn btn-round text-light btn-green">{{$cart->code}}</span>
                    </div>
                    <div class="box">
                        <div class="info">
                            ...
                            <div class="content-group">
                                ...
                                <span class="content">{{$cart->buyer_fullname}}</span>
                            </div>
                            <div class="content-group">
                                <span class="label">Email:</span>
                                <span class="content">{{$cart->buyer_email}}</span>
                            </div>
                            <div class="content-group">
                                <span class="label">SĐT:</span>
                                <span class="content">{{$cart->buyer_phone}}</span>
                            </div>
                        </div>
                        <div class="address">
                            <h3 class="title">Địa Chỉ Nhận Hàng</h3>
                            <p class="label">{{$cart->address}}</p>
                        </div>
                    </div>
                    <div class="box-flex d-flex">
                        <p class="label text-pink-weight fw-600 fs-18">Thắc Mắc Xin Liên Hệ:18008198</p>
                        <div>
                            <a href="{{route("home")}}" class="mr-10 btn-sm btn btn-round btn-yellow">Tiếp Tục Mua
                                Hàng</a>
                ...
                <div class="box-product">
                        ...
                        <li class="product-item">
                            ...
                            <div class="product-info px-10">
                                ...
                                <div class="fs-10 py-5 text-primary">
                                    <span class="text-dark">Số Lượng:</span> {{$cartProduct->qty}} 
                                    <span class="text-dark">Giá:</span> {{currencyFormat($cartProduct->price)}}
                                </div>
                            </div>
                            <span class="product-price">
                                {{currencyFormat($cartProduct->price *$cartProduct->qty)}}
                            </span>
                        </li>
                        @endforeach
                    </ul>
                    <div class="statistical">
                        <div class="box-flex d-flex">
                            ...
                            <span class="price fs-20">{{currencyFormat($cart->total_price)}}</span>
                        </div>
                        <div class="box-flex d-flex">
