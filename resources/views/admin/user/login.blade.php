            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="{{route("admin.user.login")}}" method="POST" id="loginForm">
                            @csrf
                            <div class="form-group invalid">
                                <label class="control-label" for="email">Email:*</label>
                                <input type="text" placeholder="example@gmail.com" title="Please enter you email" value="{{old("email")}}" name="email" id="email" class="form-control is-invalid">
                                <span class="help-block small invalid-feedback"></span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Password:*</label>
                                <input type="password" title="Please enter your password" placeholder="******" value="{{old("password")}}" name="password" id="password" class="form-control">
                                <span class="help-block small invalid-feedback"></span>
                            </div>
