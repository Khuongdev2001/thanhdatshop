...
@section("title",isset($cat) ? "Cập Nhật Danh Mục Bài Viết" :"Thêm Danh Mục Bài Viết")
@section("css")
    <!-- datatable CSS
		============================================ -->
...
@section("js")
    ...
    <script>
        ...
        $('#table.dataTable').DataTable({
            ...
            columns: [
                { data: "cat_id", name: "cat_id",orderable: false },
                { data: "cat_thumbnail", name:"cat_thumbnail"},
        ...
        UploadFile({
            ...
            file: "{{isset($cat->cat_thumbnail) ? asset($cat->cat_thumbnail) : "" }}"
        });
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="review-tab-pro-inner">
                  <div id="myTabContent" class="tab-content custom-product-edit">
                     ...
                     ? route("admin.product.category.update",$cat->cat_id) 
                     : route("admin.product.category.add")
                        ...
                        <div class="row">
                                ...
                                <table id="table" class="dataTable text-white">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="cat_thumbnail">A.Danh Mục</th>
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- thumbnail-->
                                <div class="form-group">
                                    <span class="text-white">Ảnh Danh Mục</span>
                                ...
                                <div class="text-center custom-pro-edt-ds">
                                    ...
                                    <a href="{{route("admin.product.category.add")}}" class="btn btn-ctl-bt waves-effect waves-light">Quay Lại Thêm D.Mục</a>
                                 </div>
                            </div>
                        </div>
                     </form>
