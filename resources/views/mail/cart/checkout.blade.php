        ...
        <div style="padding: 30px 20px;">
            ...
            >
                <tbody>
                    <tr>
                        <td>
                            <h1 style="font-size: 17px; font-weight: bold; color: #444; padding: 0 0 5px 0; margin: 0;">Cảm ơn quý khách {{$cart["buyer_fullname"]}} đã đặt hàng tại <span class="il">Thành Đạt</span>,</h1>

                            <p style="margin: 4px 0; font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #444; line-height: 18px; font-weight: normal;">
                                <span class="il">Thành Đạt</span> rất vui thông báo đơn hàng {{$cart["code"]}} của quý khách đã được tiếp nhận và đang trong quá trình xử lý. <span class="il">Thành Đạt</span> sẽ thông báo đến quý khách ngay khi hàng chuẩn bị
                                được giao.
                            </p>
                            ...
                            <h3 style="font-size: 13px; font-weight: bold; color: #02acea; text-transform: uppercase; margin: 20px 0 0 0; border-bottom: 1px solid #ddd;">
                                Thông tin đơn hàng {{$cart["code"]}} <span style="font-size: 12px; color: #777; text-transform: none; font-weight: normal;">({{$cart["created_at"]}})</span>
                            </h3>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding: 3px 9px 9px 9px; border-top: 0; font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #444; line-height: 18px; font-weight: normal;" valign="top">
                                            <span style="text-transform: capitalize;">{{$cart["buyer_fullname"]}}</span><br />
                                            <a href="mailto:khuongmy1@gmail.com" target="_blank">{{$cart["buyer_email"]}}</a><br />
                                            {{$cart["buyer_phone"]}}
                                        </td>
                        ...
                        <td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="background: #f5f5f5;" width="100%">
                                ...
                                <tbody bgcolor="#eee" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #444; line-height: 18px;">
                                    ...
                                    <tr>
                                        <td align="left" style="padding: 3px 9px;" valign="top"><span>{{$product["product_title"]}}</span><br /></td>
                                        <td align="left" style="padding: 3px 9px;" valign="top"><span>{{currencyFormat($product["price"])}}</span></td>
                                        ...
                                        <td align="right" style="padding: 3px 9px;" valign="top"><span>{{currencyFormat($product["price"]*$product["qty"])}}</span></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #444; line-height: 18px;">
                                    <tr>
                                        ...
                                        <td align="right" style="padding: 5px 9px;"><span>{{currencyFormat($cart["total_price"])}}</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr bgcolor="#eee">
                                        ...
                                        <td align="right" style="padding: 7px 9px;">
                                            <strong>
                                                <big><span>{{currencyFormat($cart["total_price"])}}</span> </big>
                                            </strong>
                                        </td>
                                    </tr>
                                </tfoot>
                            ...
                            <div style="margin: auto;">
                                <a
                                    href="{{route("cart.order",$cart->cart_id)}}"
                                    style="
